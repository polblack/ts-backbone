...
export namespace ModbusTypes{
    export abstract class ModbusType{
        ...
        protected value:any;
        protected mItem:Modbus.ModbusItem;
        protected lang:i18n.i8nHelper;
        public constructor(item:Modbus.ModbusItem,lang:i18n.i8nHelper)
        {
            this.mItem = item;
            this.lang = lang;
        }
    ...
    export class EnumType extends ModbusType {
        public constructor (item:Modbus.ModbusItem,lang:i18n.i8nHelper){ super(item,lang); }
        /**
         * Validate:
         * @param: value
